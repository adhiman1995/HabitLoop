...
const HeatmapWidget = () => {
    ...
    return (
        <div className="bg-white rounded-lg p-8 shadow-sm border border-slate-200 h-full min-h-[240px] flex flex-col justify-center overflow-hidden">
                        ...
                        <div className="grid grid-cols-7 gap-1.5">
                            {month.days.map((day) => (
                                day.empty ? (
                                    ...
                                    <div
                                        key={day.id}
                                        className={`w-3 h-3 md:w-3.5 md:h-3.5 rounded-sm transition-all duration-300 ${day.color} hover:scale-125 hover:ring-2 hover:ring-blue-200 cursor-pointer`}
