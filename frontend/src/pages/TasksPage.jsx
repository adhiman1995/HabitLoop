    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="flex flex-col xl:flex-row items-center justify-between gap-4">
                {/* Filter Bar */}
                <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-1.5 flex flex-col sm:flex-row items-center gap-4 flex-grow w-full xl:w-auto">
                    <div className="flex items-center gap-2 pl-4 py-2 text-slate-400 font-bold uppercase tracking-wider text-xs whitespace-nowrap border-b sm:border-b-0 sm:border-r border-slate-100 sm:pr-4 w-full sm:w-auto">
                        <FiList className="text-lg text-blue-500" />
                                    ...
                                    <td colSpan="5" className="px-6 py-24 text-center">
                                        <div className="flex flex-col items-center justify-center gap-6 opacity-60">
                                            <div className="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center">
                                                <FiList className="text-4xl text-slate-300" />
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-xl font-bold text-slate-700">No tasks found</p>
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-3 border-b border-r border-slate-200 dark:border-slate-700">
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    {task.description && (
                                                        <span className={`text-sm leading-relaxed ${task.status === 'Completed' ? 'text-slate-300 line-through' : 'text-slate-500'}`}>
                                                            {task.description}
                                                        </span>
                                                    )}
                                                </div>
                                            ...
                                            <td className="px-5 py-3 align-top pt-4 border-b border-r border-slate-200">
                                                {activityName ? (
                                                    ...
                                                    <span className="text-slate-300 text-xs italic font-medium px-2 py-1">--</span>
                                                )}
                                            </td>
